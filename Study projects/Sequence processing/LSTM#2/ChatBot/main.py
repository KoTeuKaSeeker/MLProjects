    ...
    for count_replies_in_sample in range(1, len(dialogues_in_sequences[dialogue_id])):
        ...
        for reply_id in range(count_replies_in_sample):
            for word_id in range(len(dialogues_in_sequences[dialogue_id][reply_id])):
                ...
                word_index_train_input[temp_sample_id].append([general_word_id + 1])
                reply_index_train_input[temp_sample_id].append([reply_id + 1])
                person_id_train_input[temp_sample_id].append([reply_id % 2 + 1])
                general_word_id += 1
...
def init_encoder_decoder_model():
    ...
    encoder_word_input_mask = layers.Masking(mask_value=0)(encoder_word_input)
    encoder_word_index_input_mask = layers.Masking(mask_value=0)(encoder_word_index_input)
    encoder_reply_index_input_mask = layers.Masking(mask_value=0)(encoder_reply_index_input)
    encoder_person_index_input_mask = layers.Masking(mask_value=0)(encoder_person_index_input)

    encoder_word_embedded = layers.Embedding(input_dim=encoder_vocab_size, output_dim=64, input_shape=(None,),
                                             name='encoder_word_embedded')
    encoder_word_index_embedded = layers.Embedding(input_dim=encoder_max_value_word_index, output_dim=64,
                                                   input_shape=(None,), name='encoder_word_index_embedded')
    encoder_reply_index_embedded = layers.Embedding(input_dim=encoder_max_reply_index, output_dim=16,
                                                    input_shape=(None,), name='encoder_reply_index_embedded')

    encoder_word_embedded_output = encoder_word_embedded(encoder_word_input_mask)
    encoder_word_index_embedded_output = encoder_word_index_embedded(encoder_word_index_input_mask)
    encoder_reply_index_embedded_output = encoder_reply_index_embedded(encoder_reply_index_input_mask)
    ...
    decoder_lstm_output_1, decoder_state_h_1, decoder_state_c_1 = decoder_lstm_1(decoder_input,
                                                                                 initial_state=encoder_states_1)
    decoder_lstm_output_2, decoder_state_h_2, decoder_state_c_2 = decoder_lstm_2(decoder_lstm_output_1,
                                                                                 initial_state=encoder_states_2)
    decoder_lstm_output_3, decoder_state_h_3, decoder_state_c_3 = decoder_lstm_3(decoder_lstm_output_2,
                                                                                 initial_state=encoder_states_3)
    ...
    decoder_encoder_chat_bot = keras.Model(inputs=[encoder_word_input,
                                                   ...
                                                   decoder_input],
                                           outputs=decoder_dense_output)
    return decoder_encoder_chat_bot


print('1. Create a new model')
print('2. Load a model')
num = input('Enter a selection: ')
path = input('Enter a path to save/load: ')

decoder_encoder_chat_bot = None

if num == '1':
    decoder_encoder_chat_bot = init_encoder_decoder_model()
else:
    decoder_encoder_chat_bot = tf.keras.models.load_model(path)
...
print('Learning is break')

is_need_to_save = input('Do you need to save model?(0 - No, 1 - Yes)')

if is_need_to_save == '1':
    print('Saving model...')
    decoder_encoder_chat_bot.save(path)
...
r_merged = layers.Concatenate()([decoder_encoder_chat_bot.get_layer('encoder_word_embedded').output,
                                 decoder_encoder_chat_bot.get_layer('encoder_word_index_embedded').output,
                                 decoder_encoder_chat_bot.get_layer('encoder_reply_index_embedded').output,
                                 decoder_encoder_chat_bot.get_layer('encoder_person_index_input').output])

r_encoder_lstm_1 = decoder_encoder_chat_bot.get_layer('encoder_lstm_1')
r_encoder_lstm_2 = decoder_encoder_chat_bot.get_layer('encoder_lstm_2')
r_encoder_lstm_3 = decoder_encoder_chat_bot.get_layer('encoder_lstm_3')

r_encoder_lstm_output_1, r_encoder_state_h_1, r_encoder_state_c_1 = r_encoder_lstm_1(r_merged, initial_state=encoder_input_states_1)
r_encoder_lstm_output_2, r_encoder_state_h_2, r_encoder_state_c_2 = r_encoder_lstm_2(r_encoder_lstm_output_1, initial_state=encoder_input_states_2)
r_encoder_lstm_output_3, r_encoder_state_h_3, r_encoder_state_c_3 = r_encoder_lstm_3(r_encoder_lstm_output_2, initial_state=encoder_input_states_3)
...
chat_bot_encoder = keras.Model(inputs=[decoder_encoder_chat_bot.get_layer('encoder_word_input').output,
                                       decoder_encoder_chat_bot.get_layer('encoder_word_index_input').output,
                                       decoder_encoder_chat_bot.get_layer('encoder_reply_index_input').output,
                                       decoder_encoder_chat_bot.get_layer('encoder_person_index_input').output,
...
r_decoder_lstm_1 = decoder_encoder_chat_bot.get_layer('decoder_lstm_1')
r_decoder_lstm_2 = decoder_encoder_chat_bot.get_layer('decoder_lstm_2')
r_decoder_lstm_3 = decoder_encoder_chat_bot.get_layer('decoder_lstm_3')
r_decoder_dense = decoder_encoder_chat_bot.get_layer('decoder_dense')

r_decoder_lstm_output_1, r_decoder_state_h_1, r_decoder_state_c_1 = r_decoder_lstm_1(decoder_encoder_chat_bot.get_layer('decoder_input').output, initial_state=r_decoder_input_states_1)
r_decoder_lstm_output_2, r_decoder_state_h_2, r_decoder_state_c_2 = r_decoder_lstm_2(r_decoder_lstm_output_1, initial_state=r_decoder_input_states_2)
r_decoder_lstm_output_3, r_decoder_state_h_3, r_decoder_state_c_3 = r_decoder_lstm_3(r_decoder_lstm_output_2, initial_state=r_decoder_input_states_3)
r_decoder_dense_output = r_decoder_dense(r_decoder_lstm_output_3)
...
chat_bot_decoder = keras.Model(inputs=[decoder_encoder_chat_bot.get_layer('decoder_input').output, r_decoder_input_states], outputs=[r_decoder_dense_output, r_decoder_states])
